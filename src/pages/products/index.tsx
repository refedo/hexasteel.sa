...
const services = [
  {
    ...
    longDescription: 'Complete structural design and engineering services using advanced software and experienced professionals.',
    features: [],
    process: [],
    benefits: [],
    icon: (
  ...
  },
  {
    ...
    longDescription: 'State-of-the-art manufacturing facility with precision equipment and quality control processes.',
    features: [],
    process: [],
    benefits: [],
    icon: (
  ...
  },
  {
    ...
    longDescription: 'Professional installation teams with extensive experience in PEB and steel structure assembly.',
    features: [],
    process: [],
    benefits: [],
    icon: (
  ...
  },
  {
    ...
    longDescription: 'Comprehensive project management from inception to completion with dedicated project managers.',
    features: [],
    process: [],
    benefits: [],
    icon: (
  ...
  },
  {
    ...
    longDescription: 'Expert technical support and consultation for all your steel structure needs.',
    features: [],
    process: [],
    benefits: [],
    icon: (
  ...
  },
  {
    ...
    longDescription: 'Expert consultation for steel structure solutions, including feasibility studies and technical advice.',
    features: [],
    process: [],
    benefits: [],
    icon: (
